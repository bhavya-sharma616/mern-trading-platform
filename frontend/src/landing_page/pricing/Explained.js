...
function Explained() {
  return (
    <div className="container" style={{ width: "80%%" ,color:"#424242"}}>
      <h2>Charges explained</h2>
      <div className="row" style={{fontSize:"12px" ,width:"100%"}}>
        ...
        <div className="col  p-4">
         ...
         <p> Tax levied by the government on the services rendered. 18% of (
